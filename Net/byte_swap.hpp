...
{
    if (is_little()) {
        return ((_x & 0xff00000000000000ul) >> 56)
               | ((_x & 0x00ff000000000000ul) >> 40)
               | ((_x & 0x0000ff0000000000ul) >> 24)
               | ((_x & 0x000000ff00000000ul) >> 8)
               | ((_x & 0x00000000ff000000ul) << 8)
               | ((_x & 0x0000000000ff0000ul) << 24)
               | ((_x & 0x000000000000ff00ul) << 40)
               | ((_x & 0x00000000000000fful) << 56);
    }
    return _x;
}
